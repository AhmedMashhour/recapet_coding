...
class ReceivedTransfersRelationManager extends RelationManager
{
    protected static string $relationship = 'receivedTransfers';

    protected static ?string $title = 'Received Transfers';
